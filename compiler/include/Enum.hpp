...
public:
  static std::string ToString(Tag value) {
    ...
    case Tag::ASSIGN:
      return "Tag::ASSIGN";
    case Tag::LEFT_BRACE:
      return "Tag::LEFT_BRACE";
    case Tag::RIGHT_BRACE:
      return "Tag::RIGHT_BRACE";
    case Tag::LEFT_BRACKET:
      return "Tag::LEFT_BRACKET";
    case Tag::RIGHT_BRACKET:
      return "Tag::RIGHT_BRACKET";
    case Tag::LEFT_PARENTHESIS:
      return "Tag::LEFT_PARENTHESIS";
    case Tag::RIGHT_PARENTHESIS:
      return "Tag::RIGHT_PARENTHESIS";
    case Tag::DOT:
      return "Tag::DOT";
    case Tag::COMMA:
      return "Tag::COMMA";
...
public:
  static std::string ToString(ExpressionType value) {
    ...
    case ExpressionType::RESET:
      return "ExpressionType::RESET";
    case ExpressionType::SHIFT:
      return "ExpressionType::SHIFT";
