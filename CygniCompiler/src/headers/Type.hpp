...
class VoidType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::VOID; }

  bool Equals(const Ptr<Type>& other) override {
    return other->GetTypeCode() == TypeCode::VOID;
  }

  String ToString() override { return "Void"; }
};

class AnyType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::ANY; }

  bool Equals(const Ptr<Type>& other) override {
    return other->GetTypeCode() == TypeCode::ANY;
  }

  String ToString() override { return "Any"; }
};

class IntType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::INT; }

  bool Equals(const Ptr<Type>& other) override {
    return other->GetTypeCode() == TypeCode::INT;
  }

  String ToString() override { return "Int"; }
};

class FloatType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::FLOAT; }

  bool Equals(const Ptr<Type>& other) override {
    return other->GetTypeCode() == TypeCode::FLOAT;
  }

  String ToString() override { return "FLOAT"; }
};

class LongType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::LONG; }

  bool Equals(const Ptr<Type>& other) override {
    return other->GetTypeCode() == TypeCode::LONG;
  }

  String ToString() override { return "Long"; }
};

class DoubleType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::DOUBLE; }

  bool Equals(const Ptr<Type>& other) override {
    return other->GetTypeCode() == TypeCode::DOUBLE;
  }

  String ToString() override { return "Double"; }
};

class CharType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::CHAR; }

  bool Equals(const Ptr<Type>& other) override {
    return other->GetTypeCode() == TypeCode::CHAR;
  }

  String ToString() override { return "Char"; }
};

class StringType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::STRING; }
...
class BoolType : public Type {
 public:
  TypeCode GetTypeCode() override { return TypeCode::BOOL; }

  bool Equals(const Ptr<Type>& other) override {
    return other->GetTypeCode() == TypeCode::BOOL;
  }

  String ToString() override { return "Bool"; }
};
...
class ArrayType : public Type {
 public:
  ...
  explicit ArrayType(Ptr<Type> element) : element{std::move(element)} {}
  ...
  String ToString() override { return "Array[" + element->ToString() + "]"; }
};
...
class FunctionType : public Type {
 public:
  ...
  TypeCode GetTypeCode() override { return TypeCode::FUNCTION; }
  ...
  bool Equals(const Ptr<Type>& other) override {
    if (other->GetTypeCode() == TypeCode::FUNCTION) {
      ...
      if (parameters.size() == function->parameters.size()) {
        return std::equal(parameters.begin(), parameters.end(),
  ...
  String ToString() override {
    auto items = Enumerate::Map(
        parameters, [](const Ptr<Type>& t) { return t->ToString(); });
