...
void TestTypeChecker::Test1() {
  ...
  //   // OutputTypeRecord("test_output/code3-types.txt",
  //   typeChecker.typeRecord); std::ofstream
  //   stream("test_output/ast-test3.json"); auto json =
  //   TestParser::ProgramToJson(program); auto toString = [](const Ptr<Type>&
  //   type) { return type->ToString(); }; AttachToJson<Ptr<Type>,
  //   decltype(toString)>(typeChecker.typeRecord, "type",
  //                                               json, toString);
